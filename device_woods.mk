...
# prebuilt_kernel
#TARGET_PREBUILT_KERNEL := device/motorola/woods/zImage-dtb
#ifeq ($(TARGET_PREBUILT_KERNEL),)
#    LOCAL_KERNEL := device/motorola/woods/zImage-dtb
#else
...
PRODUCT_COPY_FILES := device/motorola/woods/config/apns-conf.xml:system/etc/apns-conf.xml
